...
class keyword {
	...
	def WebDriver getCurrentSessionMobileDriver() {
		println("location: "+MobileDriverFactory.getDriver().location());
		MobileDriverFactory.getDriver().setLocation(new Location(12.881070, 77.522433, 10));
		println("location: "+MobileDriverFactory.getDriver().location());
	...
	def Location getLocation() {
		println("location: "+MobileDriverFactory.getDriver().location());
		KeywordUtil.markPassed("location: "+MobileDriverFactory.getDriver().location())
		return MobileDriverFactory.getDriver().location();
	}
}